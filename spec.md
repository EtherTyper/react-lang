...
- [X] [Statements](#statements)
  - [X] [ExpressionStatement](#expressionstatement)
  - [X] [BlockStatement](#blockstatement)
  - [X] [EmptyStatement](#emptystatement)
  - [X] [DebuggerStatement](#debuggerstatement)
  - [X] [WithStatement](#withstatement)
  - [X] [Control flow](#control-flow)
    - [X] [ReturnStatement](#returnstatement)
    - [X] [LabeledStatement](#labeledstatement)
    - [X] [BreakStatement](#breakstatement)
    - [X] [ContinueStatement](#continuestatement)
  - [X] [Choice](#choice)
    - [X] [IfStatement](#ifstatement)
    - [X] [SwitchStatement](#switchstatement)
      - [X] [SwitchCase](#switchcase)
  - [X] [Exceptions](#exceptions)
    - [X] [ThrowStatement](#throwstatement)
    - [X] [TryStatement](#trystatement)
      - [X] [CatchClause](#catchclause)
  - [X] [Loops](#loops)
    - [X] [WhileStatement](#whilestatement)
    - [X] [DoWhileStatement](#dowhilestatement)
    - [X] [ForStatement](#forstatement)
...
- [X] [Expressions](#expressions)
  ...
  - [X] [Binary operations](#binary-operations)
    ...
    - [X] [MemberExpression](#memberexpression)
  ...
  - [X] [DoExpression](#doexpression)
- [X] [Template Literals](#template-literals)
  - [X] [TemplateLiteral](#templateliteral)
  - [X] [TaggedTemplateExpression](#taggedtemplateexpression)
  - [X] [TemplateElement](#templateelement)
- [X] [Patterns](#patterns)
  - [X] [ObjectPattern](#objectpattern)
  - [X] [ArrayPattern](#arraypattern)
  - [X] [RestElement](#restelement)
  - [X] [AssignmentPattern](#assignmentpattern)
- [X] [Classes](#classes)
  - [X] [ClassBody](#classbody)
  - [X] [ClassMethod](#classmethod)
  - [X] [ClassPrivateMethod](#classprivatemethod)
  - [X] [ClassProperty](#classproperty)
  - [X] [ClassPrivateProperty](#classprivateproperty)
  - [X] [ClassDeclaration](#classdeclaration)
  - [X] [ClassExpression](#classexpression)
  - [X] [MetaProperty](#metaproperty)
- [ ] [Modules](#modules)
