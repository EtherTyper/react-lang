...
testElement(_react2.default.createElement("array", null, _react2.default.createElement("await", null, _react2.default.createElement("yield", {
  delegate: true
}, _react2.default.createElement("super", null))), _react2.default.createElement("updateExpression", {
  operator: "--",
  prefix: false
}, _react2.default.createElement("thisExpression", null)), _react2.default.createElement("unaryExpression", {
  operator: "+",
  prefix: true
}, _react2.default.createElement("import", null)), _react2.default.createElement("binaryExpression", {
  operator: "==="
}, 5, 4)), 'Array of (pseudo)-Expressions'); // Functional (User-defined) Components
