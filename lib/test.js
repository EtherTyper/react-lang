...
function testElement(element) {
  ...
  try {
    ...
    if (process.env.DEBUG) {
      var stack = (0, _cleanStacktrace2.default)(exception.stack, function (line) {
        var paths = /.*\((.*)\).?/.exec(line) || [];
        return paths[1] ? line.replace(paths[1], _path2.default.relative(process.cwd(), paths[1])) : line;
      });
      console.log("".concat(description, ": ").concat(stack));
    } else {
...
testElement(_react2.default.createElement("classMethod", {
  ...
  kind: "get",
  params: [_react2.default.createElement("arrayPattern", null, _react2.default.createElement("identifier", null, "hello"), _react2.default.createElement("identifier", null, "world"), _react2.default.createElement("identifier", null, "object"))]
}, _react2.default.createElement("decorator", null, _react2.default.createElement("identifier", null, "greetable")), _react2.default.createElement("identifier", null, "helloWorld"), _react2.default.createElement("block", null, _react2.default.createElement("debugger", null))), 'ClassMethod');
...
testElement(_react2.default.createElement("classDeclaration", {
  ...
  "static": true,
  computed: true
}, _react2.default.createElement("identifier", null, "hello"), _react2.default.createElement("identifier", null, "world"))))); // Features that I added
