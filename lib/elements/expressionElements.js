  ...
  return function (_Super) {
    ...
    _createClass(BasicElements, null, [{
      ...
      value: function arrowFunction(element, props, children) {
        var _props$children$map = props.children.map(_.generateAST),
            _props$children$map2 = _slicedToArray(_props$children$map, 1),
            body = _props$children$map2[0];

        var id = props.id || null;
        var params = props.params;
        var async = typeof props.async === 'boolean' ? props.async : false;
        var expression = typeof props.expression === 'boolean' ? props.expression : false;
