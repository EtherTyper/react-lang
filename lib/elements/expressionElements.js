...
var Expressions = function Expressions() {
  ...
  return function (_Super) {
    ...
    _createClass(BasicElements, null, [{
      ...
      key: "callExpression",
      value: function callExpression(element, props, children) {
        var optional = typeof props.optional === 'boolean' ? props.optional : null;

        var _children5 = _toArray(children),
            callee = _children5[0],
            callArguments = _children5.slice(1);
      ...
      key: "newExpression",
      value: function newExpression(element, props, children) {
        return (0, _.generateAST)(_react2.default.createElement("callExpression", _extends({}, props, {
          type: "NewExpression"
        })));
      }
    }]);
