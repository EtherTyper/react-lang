  ...
  return function (_Super) {
    ...
    _createClass(BasicElements, null, [{
      ...
      value: function arrowFunction(element, props, children) {
        ...
        var expression = body.type !== 'BlockStatement';
        return _extends({}, (0, _.generateAST)(_react2.default.createElement("function", _extends({}, props, {
          type: "ArrowFunctionExpression",
          id: null,
          generator: false,
          async: async,
          body: expression ? null : body
        }))), (0, _.generateAST)(_react2.default.createElement("expression", _extends({}, props, {
          type: "ArrowFunctionExpression"
        }))), {
          body: body,
      ...
      key: "spread",
      value: function spread(element, props, children) {
        var _children9 = _slicedToArray(children, 1),
            argument = _children9[0];
      ...
      key: "member",
      value: function member(element, props, children) {
        var _children10 = _slicedToArray(children, 2),
            object = _children10[0],
            property = _children10[1];

        var computed = typeof props.computed === 'boolean' ? props.computed : false;
        var optional = typeof props.optional === 'boolean' ? props.optional : null;
        return _extends({}, (0, _.generateAST)(_react2.default.createElement("expression", {
          type: "MemberExpression"
        })), (0, _.generateAST)(_react2.default.createElement("pattern", {
          type: "MemberExpression"
        })), {
          object: object,
          property: property,
      ...
      value: function conditional(element, props, children) {
        var _children11 = _slicedToArray(children, 3),
            test = _children11[0],
            consequent = _children11[1],
            alternate = _children11[2];
      ...
      value: function call(element, props, children) {
        ...
        var _children12 = _toArray(children),
            callee = _children12[0],
            callArguments = _children12.slice(1);
      ...
      key: "do",
      value: function _do(element, props, children) {
        var _children13 = _slicedToArray(children, 1),
            body = _children13[0];
