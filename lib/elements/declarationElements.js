    ...
    _createClass(BasicElements, null, [{
      ...
      value: function functionDeclaration(element, props, children) {
        ...
        return _extends({}, (0, _.generateAST)(_react2.default.createElement("function", _extends({}, props, {
          ...
          generator: generator,
          async: async
        }), body)), (0, _.generateAST)(_react2.default.createElement("declaration", {
          type: "FunctionDeclaration"
        })));
      }
    }, {
      key: "variableDeclaration",
      value: function variableDeclaration(element, props, children) {
        var declarations = children;
        var kind = props.kind || 'let';
        return _extends({}, (0, _.generateAST)(_react2.default.createElement("declaration", {
      ...
      value: function variableDeclarator(element, props, children) {
        var _children = _slicedToArray(children, 2),
            id = _children[0],
            _children$ = _children[1],
            init = _children$ === void 0 ? null : _children$;
