...
var Patterns = function Patterns() {
  ...
  return function (_Super) {
    ...
    _createClass(BasicElements, null, [{
      ...
      key: "assignmentProperty",
      value: function assignmentProperty(element, props, children) {
        ...
        return _extends({}, (0, _.generateAST)(_react2.default.createElement("objectProperty", props)), {
          value: value
        });
      }
    }, {
      key: "objectPattern",
      value: function objectPattern(element, props, children) {
      ...
      value: function arrayPattern(element, props, children) {
        var elements = children.map(function (child) {
          return child.type === 'NullLiteral' ? null : child;
        });
        return _extends({}, (0, _.generateAST)(_react2.default.createElement("pattern", {
          type: "ArrayPattern"
        })), {
