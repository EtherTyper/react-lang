...
var Parser = function Parser() {
  ...
  return function (_Super) {
    ...
    _createClass(BasicElements, null, [{
      key: "parse",
      value: function parse(element, props, children) {
        var babylon = props.babylon;

        if (babylon) {
          var _children = _slicedToArray(children, 1),
              code = _children[0];

          var ast = babylon.parse(code.value).program;

          var handler = props.handler || function (program) {
            return program;
          };
