  ...
  return function (_Super) {
    ...
    _createClass(BasicElements, null, [{
      ...
      value: function forIn(element, props, children) {
        ...
        return _extends({}, (0, _.generateAST)(_react2.default.createElement("statement", {
          type: props.type || "ForInStatement"
        })), {
          left: left,
          right: right,
          body: body
      ...
      key: "forOf",
      value: function forOf(element, props, children) {
        var isAwait = props.await || false;
        return _extends({}, (0, _.generateAST)(_react2.default.createElement("forIn", _extends({}, props, {
          type: "ForOfStatement"
        }))), {
          await: isAwait
        });
