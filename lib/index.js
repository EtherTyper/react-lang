...
exports.render = exports.generateAST = exports.keyGeneratorFunction = void 0;
...
var keyGeneratorFunction =
/*#__PURE__*/
exports.keyGeneratorFunction = regeneratorRuntime.mark(function keyed(start) {
  var key;
...
function generateASTFromTree(element) {
  if (Array.isArray(element)) {
    return generateAST(_react2.default.createElement("arrayExpression", null, function () {
      var keyGenerator = keyGeneratorFunction(0); // Assume array parameters are stable across renders.
